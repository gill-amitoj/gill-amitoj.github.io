        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 border border-light translate-x-4 translate-y-4" />
              <img
                src="/profile.png"
                alt="Amitoj Singh"
                className="w-80 h-80 object-cover border border-light grayscale hover:grayscale-0 transition-all duration-500"
              />
            </div>
          </motion.div>
        </div>
